...
export const Create = () => {
  ...
  const [formInput, setFormInput] = useState({name: null, parent_id: null});
  ...
  const handleFormSubmit = e => {
    ...
    api().post('/api/category', formInput, {
      signal: abortController.signal,
    }).then(response => {
                ...
                <form action="/">
                  <div className="row">
                    ...
                    <div className="col-md-6 mb-10">
                      ...
                      <Select className="form-control p-1" name="parent_id" onChange={handleSelect} isDisabled={loading} options={options} placeholder="Pilih parent kategori" isClearable={true} />
                    </div>
                  </div>
